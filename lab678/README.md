...
- `RAG-запрос` — вопрос, top_k, фильтр по источнику, ответ LLM и график релевантности;
- `База знаний` — добавление, редактирование, удаление, текстовый поиск и статистика;
- `Импорт` — загрузка фактов из `.txt`, `.md`, `.json`, `.csv`;
- `Состояние` — проверка конфигурации, LLM-сервера и тестовая загрузка фактов.
